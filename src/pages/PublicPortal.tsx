                  ...
                  >
                    <div className="flex items-start gap-5">
                      ...
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold text-zinc-900 group-hover:text-amber-600 transition-colors leading-tight">{job.title}</h3>
              ...
              <div className="bg-white rounded-[40px] border border-zinc-200 overflow-hidden shadow-2xl shadow-zinc-200/50">
                <div className="p-10 border-b border-zinc-100 bg-zinc-50/50 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-3xl font-bold text-zinc-900 tracking-tight leading-tight">{selectedJob.title}</h2>
                  ...
                  <div className="p-6 bg-zinc-900 rounded-3xl text-white text-center min-w-[140px]">
                    <p className="text-[9px] font-bold uppercase tracking-widest text-amber-400 mb-1">Salário</p>
                    <p className="text-lg font-bold">{selectedJob.salary_min ? `R$ ${selectedJob.salary_min}` : 'A combinar'}</p>
                  </div>
                </div>
                ...
                <div className="p-10 grid lg:grid-cols-2 gap-12">
                  <div className="space-y-8">
                    <section>
                      <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-4">Descrição e Responsabilidades</h4>
                    ...
                    <section>
                      <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-4">Requisitos Principais</h4>
                      <div className="text-sm font-bold text-zinc-600 leading-relaxed prose prose-zinc" 
                  ...
                  <div className="space-y-8">
                    <div className="p-8 bg-zinc-900 rounded-[32px] text-white space-y-6">
                      <h4 className="text-xs font-bold text-amber-400 uppercase tracking-widest">Candidate-se Agora</h4>
                      ...
                      {applied ? (
                        <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
                          ...
                          <p className="text-sm font-bold">Candidatura Enviada!</p>
                        ...
                        <form onSubmit={handleApply} className="space-y-4">
                          <div className="space-y-1.5">
                            <label className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Nome Completo</label>
                          ...
                          <div className="space-y-1.5">
                            <label className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest ml-1">E-mail</label>
                          ...
                          <div className="space-y-1.5">
                            <label className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Currículo (PDF)</label>
                          ...
                          <button type="submit" className="w-full py-4 bg-amber-400 hover:bg-amber-500 text-amber-950 rounded-2xl text-[11px] font-bold uppercase tracking-widest transition-all shadow-xl shadow-amber-400/10 active:scale-[0.98] mt-4">
                            Enviar Currículo
                          </button>
                        </form>
                      )}
